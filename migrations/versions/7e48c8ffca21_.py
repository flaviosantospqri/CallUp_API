...
def upgrade():
    ...
    op.alter_column(
        "calls", "category_id", existing_type=postgresql.UUID(), nullable=True
    )
    op.alter_column(
        "calls", "subcategory_id", existing_type=postgresql.UUID(), nullable=True
    )
    op.alter_column(
        "calls", "employee_id", existing_type=postgresql.UUID(), nullable=True
    )
    ...
    op.alter_column(
        "employees", "company_id", existing_type=postgresql.UUID(), nullable=True
    )
    op.alter_column(
        "employees", "sector_id", existing_type=postgresql.UUID(), nullable=True
    )
...
def downgrade():
    ...
    op.alter_column(
        "employees", "sector_id", existing_type=postgresql.UUID(), nullable=False
    )
    op.alter_column(
        "employees", "company_id", existing_type=postgresql.UUID(), nullable=False
    )
    ...
    op.add_column(
        "calls",
        sa.Column(
            "selected_proposal", postgresql.UUID(), autoincrement=False, nullable=False
        ),
    )
    ...
    op.alter_column(
        "calls", "employee_id", existing_type=postgresql.UUID(), nullable=False
    )
    op.alter_column(
        "calls", "subcategory_id", existing_type=postgresql.UUID(), nullable=False
    )
    op.alter_column(
        "calls", "category_id", existing_type=postgresql.UUID(), nullable=False
    )
